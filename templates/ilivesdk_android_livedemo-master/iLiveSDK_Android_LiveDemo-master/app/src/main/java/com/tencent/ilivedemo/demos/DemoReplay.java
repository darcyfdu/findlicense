 ...
 */
public class DemoReplay extends Activity implements ITXLivePlayListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_replay);

        initView();

        if (TextUtils.isEmpty(UserInfo.getInstance().getReplayUrl())){
            finish();
        }
    ...
    protected void onResume() {
        ...
        mTxlpPlayer.startPlay(UserInfo.getInstance().getReplayUrl(), TXLivePlayer.PLAY_TYPE_VOD_MP4);
    }
